...
var setDefaultOptions = function () {
  console.log("setting default option", extensionApi)
...
extensionApi.storage.sync.get({
  ...
  enabledSites = Object.values(items.sites || defaultSites).concat(items.customSites);
...
var isSiteEnabled  = function(details) {
